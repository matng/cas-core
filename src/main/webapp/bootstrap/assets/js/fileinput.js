...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tActionUpload = '<button type="button" id="_tActionUpload" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
            '   {uploadIcon}\n</button>\n',
        ...
        defaultPreviewSettings = {
            image: {width: "96px", height: "60px"},
            html: {width: "213px", height: "160px"},
            text: {width: "160px", height: "160px"},
            video: {width: "213px", height: "160px"},
            audio: {width: "213px", height: "80px"},
            flash: {width: "96px", height: "60px"},
    ...
    $.fn.fileinput.locales.en = {
        ...
        msgLoading: '正在加载第  {index} 个总共  {files} 个  &hellip;',
        msgProgress: '正在加载文件 {index} of {files} - {name} - 已完成 {percent}%.',
