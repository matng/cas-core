...
<script type="text/javascript">
	...
	**/
	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		...
		jQuery(function($) {	
			...
			var colJson = [
							  ...
							  {"mDataProp": "rolename", "sClass":"center","bSortable":true},
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				subGridRowExpanded: function (subgridDivId, rowId) {
					...
					$("#" + subgridTableId).jqGrid({
						...
						datatype: "json",
						colNames: ['菜单名称','菜单代码','菜单路径','增加','删除','修改','查询'],
						colModel: [
			...
			function checkBoxAdd(cellvalue, options, cell){
				...
				var html = "<label class=\"position-relative\">";
			    html += "<input id=\"\" type=\"checkbox\" "+flagA+" onclick=\"smallChange('c','"+cell.id+"','"+cell.menucode+"');\" class=\"ace\" />";
			    html += "<span class=\"lbl\"></span>";
			    html += "</label>";
			return html;
			}
			...
			function checkBoxDel(cellvalue, options, cell){
				...
				var html = "<label class=\"position-relative\">";
			    html += "<input id=\"\" type=\"checkbox\" "+flagD+" onclick=\"smallChange('d','"+cell.id+"','"+cell.menucode+"');\" class=\"ace\" />";
			    html += "<span class=\"lbl\"></span>";
			    html += "</label>";
			return html;
			}
			...
			function checkBoxUpd(cellvalue, options, cell){
				...
				var html = "<label class=\"position-relative\">";
			    html += "<input id=\"\" type=\"checkbox\" "+flagU+" onclick=\"smallChange('u','"+cell.id+"','"+cell.menucode+"');\" class=\"ace\" />";
			    html += "<span class=\"lbl\"></span>";
			    html += "</label>";
			return html;
			}
			...
			function checkBoxView(cellvalue, options, cell){
				...
				var html = "<label class=\"position-relative\">";
			    html += "<input id=\"\" type=\"checkbox\" "+flagV+" onclick=\"smallChange('r','"+cell.id+"','"+cell.menucode+"');\" class=\"ace\" />";
			    html += "<span class=\"lbl\"></span>";
			    html += "</label>";
			return html;
			}
			...
			function checkModule(cellvalue, options, cell){
				...
				var html = "<label class=\"position-relative\">";
			    html += "<input id=\"\" type=\"checkbox\" "+flagM+" onclick=\"smallChange('1','"+cell.id+"','"+cell.modulecode+"');\" class=\"ace\" />";
			    html += "<span class=\"lbl\"></span>";
			    html += "</label>";
			return html;
			}
	...
	function smallChange(flag,id,code){
