	...
	function getGalleryDate(groupId){
		...
		fnAjaxPost(url,json,function(res){
			...
			for(var i = 0;i< obj.length;i++){
				...
				//var ob1 = obj[i].usetype==2?"<fmt:message key='picture_unset'/>":"<fmt:message key='picture_set'/>";
				...
				html += "<li>"+
					...
					//"</a>"+
					//"<a href=\"#\" title="+ob1+"<fmt:message key='picture_slider_info' /> onclick=\"changePicType("+obj[i].id+",2,"+obj[i].usetype+");\" >"+
