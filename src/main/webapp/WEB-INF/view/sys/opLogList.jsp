...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	...
	jQuery(function($) {	
		...
		var colJson = [
						  ...
						  {"mDataProp": "title","sWidth":"12%","sClass":"center","bSortable":false,"bSearchable": true,"mRender": displayRenderTitle},
						  {"mDataProp": "loginip","sWidth":"10%","sClass":"center","bSortable": false,"bSearchable": true },
						  {"mDataProp": "userid","sWidth":"10%","sClass":"center","bSortable": false,"bSearchable": true },
						  {"mDataProp": "loginname","sWidth":"10%","sClass":"center","bSortable": false,"bSearchable": false},
						  {"mDataProp": "optimeStr","sWidth":"15%", "sClass":"center","bSortable": false,"bSearchable": true},
		...
		function opRender(data,type,full) {		
			...
			"<a class=\'green\' href=\'javascript:void(0);\' onclick=Details(\'"+row_data+"\') data-toggle=\'modal\' data-target=\'#modal-table\'>"+
